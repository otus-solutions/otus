describe('ProjectCommunicationService_UnitTest_Suite', () => {
  ...
  it('updateFinalizedMethod_should_evoke_listIssue_by_repositoryService', () => {
    service.updateFinalized();
    expect(Injections.ProjectCommunicationRepositoryService.updateFinalized).toHaveBeenCalledTimes(1);
  });
  ...
  it('getAllIssueMessagesMethod_should_evoke_filter_by_repositoryService', () => {
    service.getAllIssueMessages(Mock);
