(function() {
  ...
  InitialConfigController.$inject = [
  ...
  function InitialConfigController(ApplicationStateService, OtusRestResourceService, RestResourceService, $http, $scope, $mdToast, $q, $mdDialog) {
