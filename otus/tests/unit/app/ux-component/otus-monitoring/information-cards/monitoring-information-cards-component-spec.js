describe('monitoringInformationCardsComponent test', function() {
  var Mock = {};
  var $controller;
  var ctrl;
  var Injections = {};
  ...
  beforeEach(function() {
    inject(function(_$injector_, _$controller_) {
      ...
      ctrl = $controller('monitoringInformationCardsCtrl', Injections);
      mockController();
    });
  });
  ...
  describe('onInit method', () => {
    beforeEach(() => {
      ...
      spyOn(ctrl, 'createInformationCards');

      ctrl.$onInit();
      ctrl.createInformationCards(mockData());
    });

    it('should onInit be defined', () => {
      expect(ctrl.$onInit).toHaveBeenCalled();
      expect(ctrl.createInformationCards).toHaveBeenCalledWith(mockData());
