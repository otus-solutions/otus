describe('otusParticipantSearchTool', function() {
  ...
  describe('filter method', function() {
    ...
    it('should transfer result data to search result component', function() {
      ...
      expect(componentController.resultComponent.setResultData).toHaveBeenCalledWith(Mock.ParticipantSearchResultService.getFiltered());
    });
  ...
  function mockParticipantSearchResultService($injector) {
    Mock.ParticipantSearchResultService = $injector.get('ParticipantSearchResultService');
    spyOn(Mock.ParticipantSearchResultService, 'filter');
    spyOn(Mock.ParticipantSearchResultService, 'getFiltered');
